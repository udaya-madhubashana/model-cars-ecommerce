...
function getDefaultMockProducts() {
    return [
        ...
        [
            ...
            'category_name' => 'Sports Cars',
            'brand' => 'Hot Wheels',
            'name' => 'Mazda RX-7 FD Die-Cast',
            'slug' => 'mazda-rx-7-fd-die-cast',
            'scale' => '1:64',
            'description' => 'Iconic crimson red Mazda RX-7 FD twin-turbo rotary sports car. Features aerodynamic front lip, smooth coupe body contours, 5-spoke silver alloy wheels, and rear wing spoiler.',
            'price' => 650.00,
            'old_price' => 799.00,
            'stock_quantity' => 14,
            'rating' => 4.9,
        ...
        [
            ...
            'category_name' => 'Sports Cars',
            'brand' => 'Hot Wheels',
            'name' => 'Toyota GR Supra 1:64',
            'slug' => 'toyota-gr-supra-1-64',
            'scale' => '1:64',
            'description' => 'Vibrant Lightning Yellow Toyota GR Supra scale model. Features sculpted aerodynamic ducktail spoiler, double-bubble roof, dual exhaust outlets, and gloss multi-spoke dark alloy wheels.',
            'price' => 699.00,
            'old_price' => null,
            'stock_quantity' => 18,
            'rating' => 4.8,
        ...
        [
            ...
            'category_name' => 'Sports Cars',
            'brand' => 'Matchbox',
            'name' => 'McLaren 720S Supercar',
            'slug' => 'mclaren-720s-supercar',
            'scale' => '1:64',
            'description' => 'Signature Azores Orange metallic McLaren 720S die-cast model with gloss black roof canopy, eye-socket aero intakes, detailed headlights, and twin high-exit titanium-style exhaust tips.',
            'price' => 799.00,
            'old_price' => 950.00,
            'stock_quantity' => 10,
            'rating' => 5.0,
        ...
        [
            ...
            'scale' => '1:64',
            'description' => 'Amplify Orange mid-engine Chevrolet Corvette C8 Stingray with dual matte black racing stripes, aggressive front splitter, side air-intake boomerangs, and black sport wheels.',
            'price' => 750.00,
            'old_price' => null,
            'stock_quantity' => 16,
            'rating' => 4.9,
            'reviews_count' => 25,
            'badge' => 'New',
            'image' => 'Chevrolet Corvette C8.jpeg',
            'is_featured' => 1
        ],
        [
            'id' => 11,
            ...
            'scale' => '1:64',
            'description' => 'Lizard Green Porsche 911 GT3 RS (992) track weapon featuring massive swan-neck rear wing with DRS actuator, carbon-fiber hood vents, front fender louvers, and lightweight BBS center-lock wheels.',
            'price' => 1199.00,
            'old_price' => 1399.00,
            'stock_quantity' => 8,
            'rating' => 5.0,
